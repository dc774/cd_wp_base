/* CDS Tooltips (last update: 6/18/25)
   - -- 
   ...
   - -- The custom <tip> and <arrow> tags should technically contain an underscore in their names, to be valid custom HTML tags.
	...
	$('.tooltip').each(function() {
		...
		if ( $(tip).length > 0 ) { // tooltip pair found
			...
			*/
			...
			$(tip).attr('id','cds-tip'+tip_count); // @todo - should I check first to make sure it doesn't already have an ID? I'd say yes!
