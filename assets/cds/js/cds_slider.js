/* CWD Image Slider (ama39, last update: 8/30/24)
   - ...
...
function cwd_slider(div,caption,time,speed,auto,random,height,path,bg,heading2,quickslide) {
	...
	jQuery(document).ready(function($) {
		...
		//$(caption_div).wrapInner('<div class="container">');
		...
		function buildNav() {
			...
			if (nextprev && slide_count > 1) {
				nextprev_html = '<div class="next-prev"><a role="button" class="prev link-button red" href="#"><span class="sr-only">Previous Slide</span><span class="fa fa-angle-left"></span></a><a role="button" class="next link-button red" href="#"><span class="sr-only">Next Slide</span><span class="fa fa-angle-right"></span></a></div>';
			}
