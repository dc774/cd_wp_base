/* CDS Motion Design (last update: 6/26/25)
   - -- 
   ------------------------------------------------------------------------- */
...
jQuery(document).ready(function($) {
	...
	/* Scroll Tracking
		...
		$(window).on('load', function(e) {
			resizeChecks(); // get a second opinion on offsets and heights after all data is loaded...
		});
		setTimeout( function(){ // ...and one more, for maximum accuracy
			resizeChecks();
		}, 1000);
	}
});
